...
import { 
  ...
  CheckSquare, Disc, Gift, History, Headset, HelpCircle, LogOut, ArrowRight, ShieldCheck 
} from 'lucide-react';
import { PKR_RATE } from '../firebase';
      ...
      <div className="glass-card p-4 mb-4 border-0 shadow-sm">
        ...
        <div className="mt-3 pt-3 border-top d-flex justify-content-between align-items-center">
          <div>
            ...
            <h4 className="fw-extrabold text-orange m-0" style={{ color: '#ff6b00' }}>
      ...
      <div className="d-flex flex-column gap-2 mb-4">
        {quickLinks.map((item) => {
          ...
          return (
            <div 
              key={item.id}
              className="glass-card p-3 d-flex align-items-center justify-content-between cursor-pointer border-0 shadow-sm hover-lift"
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content glass-modal border-0 p-4 text-center">
              ...
              <p className="text-muted small mb-4">
                Are you sure you want to log out of your SuccessX account?
              </p>

              <div className="d-flex gap-2">
                <button className="btn btn-light w-50 py-2.5 rounded-3 fw-semibold border" onClick={() => setShowLogoutModal(false)}>
                  Cancel
                </button>
                <button className="btn btn-danger w-50 py-2.5 rounded-3 fw-bold" onClick={onLogout}>
                  Yes, Logout
                </button>
              </div>
